...
function Game() {
  ...
  const userSelecetedMoveIndex = useRecoilValue(userSelectedMoveIndexAtom)
  const userSelectedMoveIndexRef = useRef(userSelecetedMoveIndex)

  useEffect(()=>{
    userSelectedMoveIndexRef.current = userSelecetedMoveIndex;
